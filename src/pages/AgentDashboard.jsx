...
// import { 
//   UserPlus, LogOut, MapPin, Trash2, Edit3, Briefcase, 
//   CheckCircle, XCircle, Clock, Save, X, Activity, Award, ChevronRight 
// } from 'lucide-react';
...
//   // REQUIREMENT: PULLS AGENT NAME FROM LOGIN SESSION
...
//     claimStatus: 0, statusMessage: "IN_PROGRESS" 
//   });
...
//   // --- LIVE STATS ---
//   const stats = {
//     completed: clientList.filter(u => u.claimStatus === 3).length,
//     canceled: clientList.filter(u => u.claimStatus === -1).length,
//     undergoing: clientList.filter(u => u.claimStatus >= 0 && u.claimStatus < 3).length
//   };
...
//   const cancelEdit = () => {
//     setEditingId(null);
//     setForm({ name: '', email: '', password: '', state: '', dist: '', mandal: '', claimStatus: 0, statusMessage: "IN_PROGRESS" });
//   };

//   return (
//     <div className="min-h-screen bg-[#f8fafc] flex flex-col text-left font-sans selection:bg-[#00ced1]/20">
      
//       {/* --- HEADER (DYNAMIC AGENT NAME) --- */}
...
//                 <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Undergoing</p>
//                 <p className="font-black text-xl text-[#00ced1]">{stats.undergoing}</p>
//               </div>
//               <div className="text-center">
//                 <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Completed</p>
//                 <p className="font-black text-xl text-green-600">{stats.completed}</p>
//               </div>
//               <div className="text-center">
//                 <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Canceled</p>
//                 <p className="font-black text-xl text-red-500">{stats.canceled}</p>
//               </div>
//            </div>
//            <div className="text-right">
//               <p className="text-[10px] font-black text-[#00ced1] uppercase tracking-widest">Agent Node</p>
//               {/* DISPLAYS THE NAME OF THE LOGGED IN AGENT */}
...
//               <h3 className="font-black text-3xl mb-10 text-slate-800">Client Registry</h3>
...
//         {/* --- DYNAMIC LIFECYCLE SECTION (LIFECYCLE STATUS BLOGS) --- */}
...
//                 <h2 className="text-5xl font-black text-slate-900 tracking-tighter leading-none">Client <span className="text-[#00ced1]">Lifecycle</span></h2>
//              </div>
//              <div className="flex gap-6 bg-slate-900 p-6 rounded-[2.5rem] text-white shadow-2xl">
//                 <div><p className="text-[8px] font-black uppercase text-[#00ced1]">Fulfillment</p><p className="text-2xl font-black">{clientList.length > 0 ? ((stats.completed / clientList.length) * 100).toFixed(0) : 0}%</p></div>
...
//                      <div className={`px-4 py-1.5 rounded-full text-[8px] font-black uppercase tracking-widest ${user.claimStatus === 3 ? 'bg-green-100 text-green-600' : user.claimStatus === -1 ? 'bg-red-100 text-red-500' : 'bg-blue-100 text-[#00ced1]'}`}>{user.statusMessage}</div>
...
//                     {user.claimStatus === 3 ? "Policy COMPLETED." : user.claimStatus === -1 ? "Policy CANCELED." : `Ongoing Stage ${user.claimStatus} verification.`}
//                   </p>
//                 </div>
